...
class CollapsingToolbar extends Component {
  ...
  render() {
    const { children,src,leftItem,leftItemPress,rightItem,rightItemPress,title,subtitle, titleColor,toolbarColor,toolbarMaxHeight,toolbarMinHeight } = this.props;
    ...
    return (
      <View style={styles.fill}>
        ...
        >
          ...
          <Text style={[styles.subtitle,{color: titleColor}]}>{subtitle}</Text>
